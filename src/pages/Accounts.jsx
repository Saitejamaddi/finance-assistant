    ...
    <div className="acc-card" style={{ borderTop: `4px solid ${account.color}` }}>
      ...
      <div className="acc-balances">
        ...
        <div className="acc-balance-row">
          ...
          <span className={`acc-balance-value acc-balance-current ${isPositive ? 'positive' : 'negative'}`}>
...
const AccountModal = ({ initial, onSave, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    onSave({
      ...form,
      openingBalance: form.openingBalance !== '' ? parseFloat(form.openingBalance) : '',
    });
  };
        ...
        <form onSubmit={handleSubmit} className="acc-modal-form">
          ...
          <div className="acc-form-group">
            ...
            <p className="acc-form-hint">
              Leave blank if you want to set a combined opening balance from the dashboard instead.
            </p>
          </div>
...
const Accounts = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Delete this account? Transactions linked to it will remain but lose their account tag.')) {
    ...
    <div className="page">
      ...
      {accounts.length === 0 ? (
        <div className="acc-empty">
          ...
          <p>Add your bank accounts to track balances separately and tag transactions to them.</p>
